...
import com.tangjie.util.Pager;
import com.tangjie.util.SystemContext;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
	...
	public void updateByHqlAlias(String hql,Object[] args,Map<String, Object> alias) {
		Query query = getSession().createQuery(hql);
		setAliasParameter(query, alias);
		setParameter(query, args);
		query.executeUpdate();
	}
	public void updateByHqlAlias(String hql,Map<String, Object> alias) {
		this.updateByHqlAlias(hql, null, alias);
	}
